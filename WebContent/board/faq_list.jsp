...
<body>
             		...
             		<dt class="faq_title"  style= "border-bottom: 1px solid #ddd;">
             		    <ul >
             		        <li class="li_faq" >
             		            <dl>
             		                <dt class="mark">Q&nbsp;&nbsp;</dt>
             		                <dd class="a" onclick="showDiv(${dto.getFaq_no() })" >${dto.getFaq_title() } </dd>
             		            </dl>
             		          </li>
             		      </ul>    
             		   </dt>    
             		 ...
             		 <!-- faq 내용 부분 -->	    
             	     	<dd id="${dto.getFaq_no() }"  style="display:none; background-color:#f4f4f2; " > 
             		         <ul>
             		             <li class="li_faq">
             		                <dl >
             		                   <dt class="mark1">A&nbsp;&nbsp;</dt>
  ...
  <!-- 페이지 처리 -->
           <div  align="center">
            ...
            <c:if test= "${page >block }">
               <li class="paginate_button previous">
                  <a href="faq_list.do?page=1">◀◀</a> </li>
           ...
           <c:forEach begin="${startBlock }" end="${endBlock }" var="i">
                 <c:if test="${i==page}" >
                      <li class="active"> <a href="faq_list.do?page=${i }">${i }</a> </li>    
                  </c:if>
           ...
           <c:if test = "${endBlock < allPage }">
              ...
              <li class="paginate_button next">
                 <a href="faq_list.do?page=${allPage}">▶▶</a></li>
             </c:if>    
           </ul>
          </div>  
